<?php
    ...
    $subject = "Welcome To Star University";
    $body = "<center><h1>Hi, $fullname </h1><br><h2> You have Applied to Star University\nWe will notify you when your application will be accpetd\nThanks for applying to Star<h2></center>";
    $headers = '';
...
<html lang="en">
  <head>
    ...
    <title>Star University | Home</title>

    <!-- Favicon -->
    <link rel="icon" href="assets/img/sadhu.jpg" type="image/jpg">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <div class="mu-header-top-left">
                  <div class="mu-top-email">
                    ...
                    <span>npatel9307@gmail.com</span>
                  </div>
                ...
                <div class="mu-header-top-right">
                  <nav>
                    <ul class="mu-top-social-nav">
                      <li><span class="fa fa-instagram"></span></a></li>
                      <li><span class="fa fa-youtube"></span></a></li>
                      <li><span class="fa fa-whatsapp"></span></a></li>
                      <li><span class="fa fa-linkedin"></span></a></li>
                      <li><span class="fa fa-skype"></span></a></li>
                    </ul>
                  </nav>
                </div>
              </div>
    ...
    <nav class="navbar navbar-default" role="navigation">  
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- LOGO -->              
          <!-- TEXT BASED LOGO -->
          <!-- <a class="navbar-brand" href="index.php"><i class="fa fa-university"></i><span>star</span></a> -->
          <a class="navbar-brand" href="index.php"><table><tbody><tr><td><img src="assets/img/sadhu.jpg" height="60px" width="60px"></td><td><i><span>star university</span></td></tr></tbody></table></a>
          <!-- IMG BASED LOGO  -->
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6">
                <div class="mu-about-us-left">
                  ...
                  <!-- End Title -->
                  <p>Established in 1920. Star University has long been a home to critical thinking, progressive edcation, and a conscientious community. The school is commited to pushing positive change and creating a caring world for everyone.</p>
                  <ul>
              ...
              <div class="col-lg-6 col-md-6">
                ...
                <a id="mu-abtus-video" href="https://www.youtube.com/watch?v=rU_pDCfDXnY" target="mutube-video">
              ...
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                  <div class="mu-single-feature">
                    ...
                    <p>Star provides you a valid and valuable certificated on completing the degree or a course. This certificate is very useful for student's placements.</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="col-lg-3 col-md-3  col-sm-6">
                  <div class="mu-our-teacher-single">
                    ...
                    <div class="mu-ourteacher-single-content">
                      ...
                      <p>Naiya has been a programming teacher ever since 2014. she knows all programming languages including scripting languages.</p>
                    </div>
                  </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6">
                  <div class="mu-our-teacher-single">
                    ...
                    <div class="mu-ourteacher-single-content">
                      ...
                      <p>Harpreet has been a physics teacher ever since 2010. she knows all about physics including quantom physics. She has best experience of teaching.</p>
                    </div>
                  </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6">
                  <div class="mu-our-teacher-single">
                    ...
                    <div class="mu-ourteacher-single-content">
                      ...
                      <p>Silky has been a english teacher ever since 2012. she knows all about english and she is a gold medalist in english.</p>
                    </div>
                  </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6">
                  <div class="mu-our-teacher-single">
                    ...
                    <div class="mu-ourteacher-single-content">
                      ...
                      <p>Neha has been a enviromnent science teacher ever since 2016. she is expert in enviromnent and gold medalist in ES subject.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div id="mu-testimonial-slide" class="mu-testimonial-content">
              ...
              <div class="mu-testimonial-item">
                <div class="mu-testimonial-quote">
                  <blockquote>
                    <p>Star University is best for computer science engineering. I have got 72 lakhs package from on campus placement. Thank you Star..!</p>
                  </blockquote>
                </div>
              ...
              <div class="mu-testimonial-item">
                <div class="mu-testimonial-quote">
                  <blockquote>
                    <p>Star is very good and well known university. The management and education is fabulous in this university.</p>
                  </blockquote>
                </div>
                <div class="mu-testimonial-img">
              ...
              <div class="mu-testimonial-item">
                <div class="mu-testimonial-quote">
                  <blockquote>
                    <p>Star has provided me everything.. there is no words for it.. Thank you so much Star..!</p>
                  </blockquote>
                </div>
                <div class="mu-testimonial-img">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3">
              <div class="mu-footer-widget">
                ...
                <address>
                  ...
                  <p>Email: npatel9307@gmail.com</p>
                </address>
              </div>
            </div>
          </div>
