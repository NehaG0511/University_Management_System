...
<head>
    <link rel="icon" type="image/jpg" href="img/sadhu.jpg"/>
    <meta charset="utf-8">
...
<div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
  ...
  <a href="contact.html" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">CONTACT</a>
       ...
       <div class="registration-form">
        <center><h2 style="font-size:6vw;">Welcome to star university</h2></center><br>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype='multipart/form-data'>
            <div class="form-icon" style="background-color: white;">
                <span><img src="img/sadhu.jpg" alt="" style="border-radius: 50%;" height="100px" width="100px"></span>
            </div>
