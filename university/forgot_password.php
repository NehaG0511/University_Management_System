...
<html lang="en">
<head>
    <title>Start | Forgot Password</title>
...
<?php
    ...
    if ( $_SERVER["REQUEST_METHOD"] == "POST" ) 
    {
        ...
        {            
            ...
            $body = "<center><h1>Start Password Recovery</h1><br><h2>Use This Link For Changing The Password :- " . "<a href='$link'>Click</a></h2></center>";
            $headers = '';
