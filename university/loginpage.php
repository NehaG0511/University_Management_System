...
#burj svg { 
    ...
    <nav class="navbar navbar-default" role="navigation">  
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- LOGO -->              
          <!-- TEXT BASED LOGO -->
          <a class="navbar-brand" href="index.php"><table><tbody><tr><td><img src="assets/img/sadhu.jpg" height="40px" width="40px"></td><td><i><span>star university</span></td></tr></tbody></table></a>
          <!-- IMG BASED LOGO  -->
 ...
 <!-- End breadcrumb -->
  ...
  <figure id=burj>
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1200 600" preserveAspectRatio="xMinYMin meet" >
  <image width="1200" height="600" xlink:href="assets/img/logimg.svg" >
  </image>
 
    <a xlink:href="teacherlogin.php">
    <rect x="485" y="280" fill="#fff" opacity="0" width="230" height="90" />
    </a>
